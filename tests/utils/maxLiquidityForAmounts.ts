...
import { Q64, Q32,MaxUint64 } from '../constants'
 ...
 */
function maxLiquidityForAmount0Imprecise(sqrtRatioAX64: JSBI, sqrtRatioBX64: JSBI, amount0: BigintIsh): JSBI {
 ...
 */
function maxLiquidityForAmount0Precise(sqrtRatioAX64: JSBI, sqrtRatioBX64: JSBI, amount0: BigintIsh): JSBI {
  if (JSBI.greaterThan(sqrtRatioAX64, sqrtRatioBX64)) {
    ;[sqrtRatioAX64, sqrtRatioBX64] = [sqrtRatioBX64, sqrtRatioAX64]
  }
 ...
 */
function maxLiquidityForAmount1(sqrtRatioAX64: JSBI, sqrtRatioBX64: JSBI, amount1: BigintIsh): JSBI {
  if (JSBI.greaterThan(sqrtRatioAX64, sqrtRatioBX64)) {
    ;[sqrtRatioAX64, sqrtRatioBX64] = [sqrtRatioBX64, sqrtRatioAX64]
  }
...
export function maxLiquidityForAmounts(
  ...
  if (JSBI.lessThanOrEqual(sqrtRatioCurrentX64, sqrtRatioAX64)) {
    ...
    const liquidity1 = maxLiquidityForAmount1(sqrtRatioAX64, sqrtRatioCurrentX64, amount1)
    return JSBI.lessThan(liquidity0, liquidity1) ? liquidity0 : liquidity1
  } else {
    return maxLiquidityForAmount1(sqrtRatioAX64, sqrtRatioBX64, amount1)
  }
}
